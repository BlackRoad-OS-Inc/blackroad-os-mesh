# Contributing to blackroad-os-mesh
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-mesh.git
cd blackroad-os-mesh

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-mesh.git
